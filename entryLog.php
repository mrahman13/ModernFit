      ...
      <div class="row">
        <div class="logMeals col-md-12 col-lg-6 p-3">
          ...
          <form class="row content mx-1 gy-2" method="post">
            <input class="form-control border-3" type="text" id="date_completed" name="date_completed" placeholder="Date:" onfocus="(this.type='date')" onblur="(this.type='text')" required>
        ...
        <div class="logWorkout col-md-12 col-lg-6 p-3">
          ...
          <form class="row content mx-1 gy-2" method="post">
            <input class="form-control border-3" onblur="(this.type='text')" onfocus="(this.type='date')" id="date_completed" name="date_completed" placeholder="Workout time:" required>
